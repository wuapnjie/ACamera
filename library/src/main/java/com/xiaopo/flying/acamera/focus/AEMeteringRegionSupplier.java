 ...
 */
public class AEMeteringRegionSupplier implements Supplier<MeteringRectangle[]> {
  private final Supplier<MeteringParameters> mMeteringParameters;
  private final Supplier<Rect> mCropRegion;

  public AEMeteringRegionSupplier(Supplier<MeteringParameters> meteringParameters,
