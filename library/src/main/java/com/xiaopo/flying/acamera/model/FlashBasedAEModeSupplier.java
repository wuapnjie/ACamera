 ...
 */
public class FlashBasedAEModeSupplier implements Supplier<Integer> {
  private final Supplier<Flash> mFlash;
  private final Supplier<Boolean> mHdrSceneMode;

  public FlashBasedAEModeSupplier(Supplier<Flash> flash,
