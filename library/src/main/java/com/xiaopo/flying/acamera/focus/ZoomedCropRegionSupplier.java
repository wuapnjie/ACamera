 ...
 */
public class ZoomedCropRegionSupplier implements Supplier<Rect> {
  private final Rect sensorArrayArea;
  private final Supplier<Float> zoomSupplier;

  public ZoomedCropRegionSupplier(Rect sensorArrayArea, Supplier<Float> zoom) {
    this.sensorArrayArea = sensorArrayArea;
    this.zoomSupplier = zoom;
  }

  @Override
  public Rect get() {
    float zoom = zoomSupplier.get();
    Rect sensor = sensorArrayArea;
